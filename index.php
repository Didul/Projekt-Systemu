...
<html>
    ...
    <?php include 'menu2.html';?>
        <div style="margin: 10em auto; width: 80%; background: rgba(100,100,100,.7">
            <h1 style="width: 70vh; margin: 5em auto; color: white;">Witamy w internetowym centrum gier!</h1>
