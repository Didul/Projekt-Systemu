        ...
        <div style="margin: 2em;">
            <div class="pure-g">
                <div class="pure-u-1-3" style="height: 50vh; color: white; background: rgba(42, 98, 182, 0.6)">
                    ...
                    <?php
                        if(!isset($_SESSION['login']) && !isset($_SESSION['pass'])) {
                            echo ('<buttton class="pure-button button-xlarge click">Zamów pakiet darmowy</buttton>');
                        }
                    ?>
                </div>
                <div class="pure-u-1-3" style="height: 50vh; color: white; background: rgba(96, 103, 112, 0.6);">
                    ...
                    <?php
                        if(!isset($_SESSION['login']) && !isset($_SESSION['pass'])) {
                            echo ('<buttton class="pure-button button-xlarge click">Zamów pakiet silver</buttton>');
                        }
                    ?>
                </div>
                <div class="pure-u-1-3" style="height: 50vh; color: white; background: rgba(228, 209, 38, 0.6);">
                    ...
                    <?php
                        if(!isset($_SESSION['login']) && !isset($_SESSION['pass'])) {
                            echo ('<buttton class="pure-button button-xlarge click">Zamów pakiet gold</buttton>');
                        }
                    ?>
                </div>
